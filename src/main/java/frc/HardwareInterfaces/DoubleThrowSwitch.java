...
public class DoubleThrowSwitch
     ...
     * @param switch1In
     *            - SingleThrowSwitch - first single throw switch of the double pole
     *            switch
     * @param switch2In
     *            - SingleThrowSwitch - second single throw switch of the double
     *            pole switch
     * @author Bob Brown
     * @written Sep 19, 2009 -------------------------------------------------------
     */
     ...
     *            is on and Channel2 is off, the switch is considered to be in the
     *            "kForward." If the reverse is true, the switch is considered to be
     *            in the "kReverse" position.
     * @param Channel2
     *            -The second port the double throw switch is connected to. When
     *            this is on and Channel1 is off, the switch is considered to be in
     *            the "kReverse." If the reverse is true, the switch is considered
     *            to be in the "kForward" position.
     * @author Alex Kneipp
     * @written Jan 18, 2016
     */
    // TODO make it worky
