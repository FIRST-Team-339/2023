...
public class UltraSonic extends AnalogInput
     ...
     *            - the port for the digital input
     * @param scalingFactor
     *            - how to scale the Analog Channel to keep the correct range on the
    ...
    public int getDistanceFromNearestBumper()
    {
        ...
        if (this.printToScreen == true)
            ...
            System.out.println("The distance is " + (normalizedDistance / 12) + "' and " + (normalizedDistance % 12)
                    + "\" or " + normalizedDistance);
            this.counter++;
            // -------------------------------------
     ...
     *
     * @param rangeValue
     *            - value to be checked to see if we are outside of this value
     ...
     *
     * @param rangeValue
     *            - value to be checked to see if we are inside of this value
     ...
     *
     * @param newValue
     *            - new number of items to check when we get a new sonar value
     * @return int - number of items to check backwards in the confidence array to
     *         make sure that the latest sonar value is "good"
