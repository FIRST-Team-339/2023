...
public class KilroyEncoder implements DoubleSupplier
    ...
    private SparkMax canEncoder = null;
     ...
     * @param canMotorController
     */
    public KilroyEncoder(SparkMax canMotorController)
        {
     ...
     */
    public KilroyEncoder(SparkMax canMotorController, int ticksPerRevolution)
        {
            this.canEncoder = canMotorController;
            type = SensorType.REV_CAN;
    ...
    public KilroyEncoder(TalonSRX canMotorController)
        ...
        {
            this.talonFX = canMotorController;
            type = SensorType.TALON_FX;
        } // end constructor - overloaded
    ...
    public double getDistance()
    {
        switch (type)
            ...
            case CIM:
                return distancePerTick * this.get();
            case TALON_FX:
                return distancePerTick * this.talonFX.getPosition().getValueAsDouble();
            default:
                return this.get();
            } // end switch type
    } // end getDistance()
