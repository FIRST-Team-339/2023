...
public abstract class TransmissionBase
     ...
     * @param rightMotor
     */
    public TransmissionBase(TalonFX leftMotor,
    TalonFX rightMotor)
        {
            this.motors = new TalonFX[2];
     ...
     * @param rightFront
     */
    public TransmissionBase(TalonFX leftRear, TalonFX rightRear,
    TalonFX leftFront, TalonFX rightFront)
        {
            this.motors = new TalonFX[4];
     ...
     */
    public TalonFX[] getAllMotorControllers()
    {
        return this.motors;
     ...
     */
    public TalonFX getMotorController(MotorPosition position)
    {
        switch (position)
            {
