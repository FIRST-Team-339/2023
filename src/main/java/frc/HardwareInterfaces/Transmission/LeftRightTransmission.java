 ...
 * @written 7/21/17
 */
public class LeftRightTransmission extends TransmissionBase
        {
        /**
         ...
         */
        public LeftRightTransmission(MotorControllerGroup leftSide, MotorControllerGroup rightSide)
                {
         ...
         * left wheels, and right controls the right wheels.
         * 
