    ...
    private static void armControl()
    {
        ...
        if (Hardware.inDemoMode == false)
            ...
            if (Hardware.leftOperator.getY() >= -Hardware.armLengthDeadband
                ...
                {
                Hardware.armLengthMotor.set(ControlMode.PercentOutput, Hardware.armLengthHoldSpeed);
                } // end if
            else
                {
                ...
                if (Hardware.leftOperator.getY() < -Hardware.armLengthDeadband)
                    {
                    Hardware.armLengthMotor.set(ControlMode.PercentOutput, ((-Hardware.armLengthMaxSpeed
