...
public class Robot extends TimedRobot
    ...
    public void disabledInit()
    {
        ...
        // disabling
        // ---------------------------------------
        Hardware.leftBottomMotor.set(-Hardware.Charging_Station_Hold_Speed); // Bryan
                                                                            // Fernandez
        Hardware.rightBottomMotor.set(-Hardware.Charging_Station_Hold_Speed); // Bryan
                                                                             // Fernandez
        // ---------------------------------------
    ...
    {
        Hardware.leftBottomMotor.set(-Hardware.Charging_Station_Hold_Speed);
        Hardware.rightBottomMotor.set(-Hardware.Charging_Station_Hold_Speed);
