...
public class Hardware
        ...
        public static void initialize()
        {
                if (robotIdentity == Identifier.CurrentYear)
                        ...
                        // ==============CAN INIT=============
                        // Motor Controllers
                        leftBottomMotor = new TalonFX(8);
                        leftTopMotor = new TalonFX(9);

                        leftBottomMotor.setInverted(true);
                        leftTopMotor.setInverted(true);

                        rightBottomMotor = new TalonFX(16);
                        rightTopMotor = new TalonFX(19);
                        ...
                        transmission = new LeftRightTransmission(leftBottomMotor,
                                        rightBottomMotor);
        ...
        // CAN DEVICES
        // **********************************************************
        public static TalonFX leftBottomMotor = null;
        public static TalonFX leftTopMotor = null;
        public static TalonFX rightBottomMotor = null;
        public static TalonFX rightTopMotor = null;

        public static KilroyEncoder rightBottomEncoder = null;
        public static KilroyEncoder leftBottomEncoder = null;
        public static BaseMotorController armLengthMotor = null;
